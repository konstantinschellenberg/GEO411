...
# data paths
bs_path = "snap_grd/GRDs_Multilooked/GRDs_Multilooked_32632_20x20/ALOS2-FBDR1_1__A-ORBIT__ALOS2067251007-150821_Cal_Spk_TC_32632_20x20.tif"
chm_path = "ancillary_data/chm_maskedtofnf_10m_resampled_to_20m_32632_-99nodata.tif"

# Reproject Backscatter
reprojcted_backscatter_path = "snap_grd/GRDs_Multilooked/GRDs_Multilooked_32632_20x20/ALOS2-FBDR1_1__A-ORBIT__ALOS2067251007-150821_Cal_Spk_TC_32632_20x20.tif"
...
bs_HV = resample(bs_HV, chm)

# Make Histogramm of Backscater
h = hist(bs_HV[bs_HV < 1], breaks=50, maxpixels=1000000)
...
ggplot(h_data, aes(x = breaks, y = counts)) +
    ...
    ggtitle("Backscatter Distribution") +
...
#####
# log
bs_HV_db = raster::calc(bs_HV, function(x) 10*log10(x))
...
##################################
# matching extents
identical(extent(bs_HV), extent(chm))
# make it a dataframe
df = data.frame(bs = values(bs_HV), chm = values(chm))
# Raster Scatterplot
